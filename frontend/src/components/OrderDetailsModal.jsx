...
function OrderDetailsModal({ order, isOpen, onClose, onUpdate, onDelete }) {
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm overflow-y-auto pb-20 sm:pb-4">
      <div className="w-full max-w-5xl my-auto flex flex-col max-h-[calc(100vh-140px)] sm:max-h-[90vh]">
