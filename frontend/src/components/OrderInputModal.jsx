...
function OrderInputModal({ isOpen, onClose, onSubmit, prefilledDate = null }) {
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm" style={{ paddingBottom: 'max(80px, calc(80px + env(safe-area-inset-bottom, 0px)))' }}>
      <div className="w-full max-w-4xl max-h-[75vh] sm:max-h-[85vh] flex flex-col overflow-hidden">
