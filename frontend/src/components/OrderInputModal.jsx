...
function OrderInputModal({ isOpen, onClose, onSubmit, prefilledDate = null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center pt-16 pb-20 px-2 sm:p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-4xl max-h-[calc(100vh-144px)] sm:max-h-[90vh] flex flex-col overflow-hidden">
